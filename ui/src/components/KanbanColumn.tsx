...
const colorMap = {
  ...
  progress: 'border-t-2 border-t-primary/70',
  done: 'border-t-2 border-t-accent/70',
  human_input: 'border-t-2 border-t-amber-500/70',
}
...
export function KanbanColumn({
  ...
  return (
    <Card className={`overflow-hidden glass ${colorMap[color]} py-0`}>
      {/* Header */}
